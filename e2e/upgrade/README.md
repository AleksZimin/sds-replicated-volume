...
- **The module never becomes ready** — the failure names the workloads that did
  not roll out and the bundle digest that was (or was not) published. Check that
  the tag exists in the dev registry and that Deckhouse is not scaled to zero.
